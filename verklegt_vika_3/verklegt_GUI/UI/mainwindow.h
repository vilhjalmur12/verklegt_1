...
private slots:
    void on_tableView_scientists_clicked(const QModelIndex &index);     //Notandi getur edit-að eða eitt þeim vísindamann sem valin er í lista
    ...
    void on_tableView_computers_clicked(const QModelIndex &index);      //Notandi getur edit-að eða eitt þeim vísindamann sem valin er í lista
    ...
    void on_lineEdit_search_textChanged(const QString &arg1);           //Filterar tölfu út frá leitarstreng frá notanda

    void on_lineEdit_searchComputer_textChanged(const QString &arg1);   //Filterar tölfu út frá leitarstreng frá notanda
    ...
    void on_tableView_computers_doubleClicked(const QModelIndex &index);//Notandi getur doulbe klikkað á tölvu til að edita

    void on_tableView_scientists_doubleClicked(const QModelIndex &index);//Notandi getur doulbe klikkað á vísindamann til að edita
